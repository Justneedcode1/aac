...
import { strategyTexts } from "@/app/kits/constants";
...
const Page = () => {
  ...
  return (
    <div className='min-h-screen relative'>
      <AnimatedRoute />
      <Hero title={"Marketing Strategy & Consulting Services"} />
          ...
          <div className='w-1/2  sm:sticky fixed bottom-0 sm:top-0 h-screen flex items-end sm:items-center sm:p-8 '>
            <AnimatePresence>
              {!menuStatus && (
                ...
                >
                  {strategyTexts.map((item: any, index: number) => {
